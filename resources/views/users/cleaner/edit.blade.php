...
@section('page-title', 'Management User / Cleaner / Edit')
...
@section('content')
  <div class="card">
    ...
    <div class="card-body">
      <form method="POST" action="{{ route('users.cleaner.update', $user) }}" enctype="multipart/form-data" class="needs-validation" novalidate>
        @csrf
        @method('PUT')
